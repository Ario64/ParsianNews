...
{
    [DbContext(typeof(ParsianNewsDbContext))]
    [Migration("20250203074842_MigAddGalleryandImageTbls")]
    partial class MigAddGalleryandImageTbls
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParsianNews.Models.Gallery", b =>
                {
            ...
            modelBuilder.Entity("ParsianNews.Models.Image", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2025, 2, 3, 11, 18, 30, 280, DateTimeKind.Local).AddTicks(9338));
            ...
            modelBuilder.Entity("ParsianNews.Models.Report", b =>
                {
                    ...
                    b.Property<string>("ReportImageAlt")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("ParsianNews.Models.ReportGroup", b =>
                {
            ...
            modelBuilder.Entity("ParsianNews.Models.Image", b =>
                {
                    b.HasOne("ParsianNews.Models.Gallery", "Gallery")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("ParsianNews.Models.Report", b =>
                {
                    b.HasOne("ParsianNews.Models.ReportGroup", "ReportGroup")
                        .WithMany("Reports")
